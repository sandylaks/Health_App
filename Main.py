...
from ServiceProvider import ServiceRegister,ServiceProvider,ImageButton
...
class LoginApp(MDApp):
    ...
    def build(self):
        ...
        screen_manager.add_widget(ServiceProvider(name="service_provider"))
        screen_manager.add_widget(ServiceRegister(name="service_register_form"))
